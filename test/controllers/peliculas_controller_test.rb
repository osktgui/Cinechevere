...
class PeliculasControllerTest < ActionController::TestCase
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post :create, pelicula: { fecha_estreno: @pelicula.fecha_estreno, genero: @pelicula.genero, imagen: @pelicula.imagen, puntuacion: @pelicula.puntuacion, sinopsis: @pelicula.sinopsis, titulo: @pelicula.titulo }
    end
  ...
  test "should update pelicula" do
    patch :update, id: @pelicula, pelicula: { fecha_estreno: @pelicula.fecha_estreno, genero: @pelicula.genero, imagen: @pelicula.imagen, puntuacion: @pelicula.puntuacion, sinopsis: @pelicula.sinopsis, titulo: @pelicula.titulo }
    assert_redirected_to pelicula_path(assigns(:pelicula))
  end
